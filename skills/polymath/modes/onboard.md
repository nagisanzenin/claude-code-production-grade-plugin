...
Read(<main entry files>)               # Architecture skeleton
```
...
Trace a user action end-to-end: HTTP request -> handler -> service -> repository -> database. Use Grep to locate the call chain without reading every file.
